...
<body>
                        ...
                        <div class="col s12 m12 l6">
                            ...
                            <div class="card" id="report-card">
                                    ...
                                    <table class=" bordered centered">
                                        ...
                                        <tbody class="mono">';
                                            ...
                                            while($row = mysql_fetch_assoc($hora)) { 
                                                ...
                                                <tr>
                                                    <td> '.$row['salon'].'</td>
                                                    <td>'.date("g:i", strtotime($row[$date])).' - '.date("g:i", strtotime($row[$date].' +1 hours 30 minutes')).'</td>
                                                </tr>
                                                ';
                                            }}
                                            ?>
                                ...
                                <div class="card-action">
                                    <a href="#report-modal-1" class="modal-trigger"><span class="cyan-text right" lang="es">Agregar un Reporte</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Modal Reportes -->
    <div id="report-modal-1" class="modal bottom-sheet-up">
        <form id="report-form" class="col s12" action="javascript:submitreport();" method="POST">
            <div class="modal-content center">
                <h4 lang="es">Reportar Un Salon Como Disponible</h4>
                <p class="center" lang="es">Selecciona el Salon que deseas reportar como disponible.</p>
            <div class="row center"><!--
                <div class="input-field col s9 m6 l9 offset-m2">
                    <i class="material-icons prefix" style="margin-top:6px;">account_circle</i>
                    <input id="email" name="email" type="email" value="" class="validate" required>
...
if (mysql_num_rows($hora) == 0) echo '<tbody><tr><td align="center">Ningun Salon actualmente Ocupado</td></tr>';
    ...
    echo '
        ...
        <div class="modal-footer">
            ...
            <a class="right modal-action modal-close waves-effect waves-teal btn-flat" lang="es">Regresar</a>
        </div>
    </form>
</div>
...
function submitreport() {
    var myData = $('#report-form').serializeArray();
    $.ajax({
        url: 'scripts/reportar.php',
        type: 'POST',
        data: $.param(myData),
        success: function(msg) {
            $('#report-modal-1').closeModal();
            setTimeout(function() {
                toastr.success('<span lang="es">Listo! Gracias por tu reporte!</span>', '',{positionClass: "toast-bottom-center",
                  showDuration: 1000,
                  hideDuration: 500,
                  showEasing: "linear",
                  showMethod: "fadeIn",
